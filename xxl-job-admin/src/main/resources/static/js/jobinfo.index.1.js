$(function() {
	...
	var jobTable = $("#job_list").dataTable({
	    ...
	    "columns": [
	                ...
	                { "data": 'alarmDingTalk', "visible" : false},
	                { "data": 'alarmKeFang', "visible" : false},
	                {
	                	"data": 'triggerStatus',
						"width":'10%',
	                	"visible" : true,
	...
	$("#job_list").on('click', '.update',function() {
		...
		$('#updateModal .form select[name=alarmDingTalk] option[value='+ row.alarmDingTalk +']').prop('selected', true);
		$("#updateModal .form input[name='alarmKeFang']").val( row.alarmKeFang );
	...
	$("#job_list").on('click', '.job_copy',function() {
		...
		$("#addModal .form input[name='alarmDingTalk']").val( row.alarmDingTalk );
		$("#addModal .form input[name='alarmKeFang']").val( row.alarmKeFang );
