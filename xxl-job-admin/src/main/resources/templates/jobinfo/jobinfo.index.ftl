				                ...
				                <thead>
					            	<tr>
                                        ...
                                        <th name="executorParam" >${I18n.jobinfo_field_executorparam}</th>
					                  	...
					                  	<th name="alarmDingTalk" >${I18n.jobinfo_field_alarmdingtalk}</th>
					                  	<th name="alarmKeFang" >${I18n.jobinfo_field_alarmkefang}</th>
			...
			<div class="modal-header">
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
	                    <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_alarmdingtalk}<font color="black">*</font></label>
	                    <div class="col-sm-4">
	                        <select class="form-control" name="alarmDingTalk" >
	                            <#list ProjectEnum as item>
	                                <option value="${item}" >${item.title}</option>
	                            </#list>
	                        </select>
	                    </div>
	                    <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_alarmkefang}<font color="black">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="alarmKeFang" placeholder="${I18n.jobinfo_field_alarmkefang_placeholder}" maxlength="100" ></div>
                    </div>
